...
def transfer_b():
    ...
    beta_type = "Blundell"
    pretrained = "bayes-experiments/1"	 # take the weights after training with domain A
    rotation = 15
...
def forgetting_c():
    ...
    beta_type = "Blundell"
    pretrained = "bayes-experiments/3"	 # take the weights after training A, B, and C
...
def forgetting_d():
    ...
    beta_type = "Blundell"
    pretrained = "bayes-experiments/4"	 # take the weights after training A, B, C, and D
